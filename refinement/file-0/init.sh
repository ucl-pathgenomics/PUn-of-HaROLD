...
mkdir C:\Oscar\OneDrive\UCL\19-5_punofharold\refinement\file-0/out
mkdir C:\Oscar\OneDrive\UCL\19-5_punofharold\refinement\file-0/error
...
echo "********************************* SCRIPT COMPLETED *********************************"
 ...
 " > C:\Oscar\OneDrive\UCL\19-5_punofharold\refinement\file-0/init.sh

     qsub C:\Oscar\OneDrive\UCL\19-5_punofharold\refinement\file-0/init.sh
