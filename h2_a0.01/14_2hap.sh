...
#!/bin/bash -l
#$ -S /bin/bash
#$ -o /cluster/scratch8b/oscar/19_4-CMV/pat_14/haplo_2_alpha_0.01/out
#$ -e /cluster/scratch8b/oscar/19_4-CMV/pat_14/haplo_2_alpha_0.01/error
#$ -l h_rt=24:00:00
#$ -l tmem=12.9G,h_vmem=12.9G
#$ -N  harold_14_2
#$ -wd /cluster/scratch8b/oscar/19_4-CMV/pat_14/haplo_2_alpha_0.01/
#$ -V
#$ -R y
...
### HAROLD
cd /cluster/scratch8b/oscar/19_4-CMV/pat_14/haplo_2_alpha_0.01/
java -jar /cluster/scratch8b/oscar/RichardProgram/HAROLD/Cluster_RG/dist/Cluster_RG.jar --count-file /cluster/scratch8b/oscar/19_4-CMV/pat_14/pat_14_harold_in.txt --haplotypes 2 --alpha-frac 0.01 --gamma-cache 10000 -H -L --threads 5 > harold_log.txt
